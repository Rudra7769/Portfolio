...
const ServicesSection = () => {
	return (
		<section id="services" className="py-20 px-6 relative z-0">
				...
				<div className="grid lg:grid-cols-2 gap-12 items-start">
					<div className="space-y-8">
						...
						<p className="text-muted-foreground text-lg">
							Our work is more than design - it's the result of deep
							thinking, keen ideas, and fearless execution across
							disciplines.
						</p>
